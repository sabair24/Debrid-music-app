...
public final class PlaylistsViewModel_HiltModules_KeyModule_ProvideFactory implements Factory<Boolean> {
  @Override
  public Boolean get() {
    return provide();
  }
  ...
  public static boolean provide() {
    return PlaylistsViewModel_HiltModules.KeyModule.provide();
  }
